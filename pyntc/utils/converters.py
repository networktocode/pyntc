...
def convert_dict_by_key(original, key_map, fill_in=False, whitelist=[], blacklist=[]):  # pylint: disable=dangerous-default-value
...
def convert_list_by_key(original_list, key_map, fill_in=False, whitelist=[], blacklist=[]):  # pylint: disable=dangerous-default-value
