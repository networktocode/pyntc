        ...
        if keyname:
            ...
            if item == "=":
                ...
                raise TomlDecodeError(
                    "Found invalid character in key name: '" + item + "'. Try quoting the key name.", original, i
                )
            ...
            while i < len(groups):
                ...
                if len(groups[i]) > 0 and (groups[i][0] == '"' or groups[i][0] == "'"):
                    ...
                    while not groupstr[0] == groupstr[-1]:
                        ...
                        if j > len(groups) + 2:
                            raise TomlDecodeError(
                                "Invalid group name '" + groupstr + "' Something " + "went wrong.", original, pos
                            )
                ...
                try:
                    ...
                    if i == len(groups) - 1:
                        if group in implicitgroups:
                            ...
                            raise TomlDecodeError(
                                "What? " + group + " already exists?" + str(currentlevel), original, pos
                            )
                except TypeError:
            ...
            if strarray:
                while b < len(a) - 1:
                    ...
                    while not self.bounded_string(ab) or (
                        len(ab) > 2 and ab[0] == ab[1] == ab[2] and ab[-2] != ab[0] and ab[-3] != ab[0]
                    ):
                        a[b] = a[b] + "," + a[b + 1]
                        ab = a[b].strip()
                        if b < len(a) - 2:
