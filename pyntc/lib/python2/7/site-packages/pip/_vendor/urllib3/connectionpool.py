...
class HTTPConnectionPool(ConnectionPool, RequestMethods):
    ...
    def _new_conn(self):
        ...
        log.debug(
            "Starting new HTTP connection (%d): %s:%s", self.num_connections, self.host, self.port or "80",
        )
...
class HTTPSConnectionPool(HTTPConnectionPool):
    ...
    def _new_conn(self):
        ...
        self.num_connections += 1
        log.debug(
            "Starting new HTTPS connection (%d): %s:%s", self.num_connections, self.host, self.port or "443",
        )
