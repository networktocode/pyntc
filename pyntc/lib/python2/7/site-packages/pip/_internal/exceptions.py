...
class NoneMetadataError(PipError):
    ...
    def __str__(self):
        ...
        return "None {} metadata found for distribution: {}".format(self.metadata_name, self.dist,)
...
class MetadataInconsistent(InstallationError):
    ...
    def __str__(self):
        # type: () -> str
        return "Requested {} has different {} in metadata: {!r}".format(self.ireq, self.field, self.built,)
