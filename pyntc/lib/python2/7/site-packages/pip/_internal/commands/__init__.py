...
commands_dict = OrderedDict(
    [
        ...
        (
            "freeze",
            CommandInfo(
                "pip._internal.commands.freeze", "FreezeCommand", "Output installed packages in requirements format.",
            ),
        ),
        ("list", CommandInfo("pip._internal.commands.list", "ListCommand", "List installed packages.",)),
        (
            "show",
            CommandInfo("pip._internal.commands.show", "ShowCommand", "Show information about installed packages.",),
        ),
        (
            "check",
            CommandInfo(
        ...
        (
            "cache",
            CommandInfo("pip._internal.commands.cache", "CacheCommand", "Inspect and manage pip's wheel cache.",),
        ),
        ...
        (
            "debug",
            CommandInfo("pip._internal.commands.debug", "DebugCommand", "Show information useful for debugging.",),
        ),
