    ...
    def _fetch_metadata(self):
        ...
        if use_lazy_wheel and remote_wheel and not preparer.require_hashes:
            ...
            with indent_log(), suppress(HTTPRangeRequestUnsupported):
                logger.info(
                    "Obtaining dependency information from %s %s", self._name, self._version,
                )
...
class LinkCandidate(_InstallRequirementBackedCandidate):
    ...
    def __init__(
        ...
        super(LinkCandidate, self).__init__(
            link=link, source_link=source_link, ireq=ireq, factory=factory, name=name, version=version,
        )
