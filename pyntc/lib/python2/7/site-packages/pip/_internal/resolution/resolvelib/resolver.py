...
class Resolver(BaseResolver):
    ...
    def resolve(self, root_reqs, check_supported_wheels):
        ...
        for req in root_reqs:
            if req.constraint:
                ...
                r = self.factory.make_requirement_from_install_req(req, requested_extras=(),)
                if r is not None:
        ...
        try:
            ...
            self._result = resolver.resolve(requirements, max_rounds=try_to_avoid_resolution_too_deep,)
    ...
    def get_installation_order(self, req_set):
        ...
        sorted_items = sorted(
            req_set.requirements.items(), key=functools.partial(_req_set_item_sorter, weights=weights), reverse=True,
        )
