...
class InstallRequirement(object):
    ...
    def ensure_build_location(self, build_dir, autodelete, parallel_builds):
        ...
        return TempDirectory(
            path=actual_build_dir, delete=delete_arg, kind=tempdir_kinds.REQ_BUILD, globally_managed=True,
        ).path
    ...
    def load_pyproject_toml(self):
        ...
        self.pep517_backend = Pep517HookCaller(self.unpacked_source_directory, backend, backend_path=backend_path,)
        ...
        if self.is_wheel:
            ...
            if self.original_link:
                direct_url = direct_url_from_link(
                    self.original_link, self.source_dir, self.original_link_is_in_wheel_cache,
                )
            install_wheel(
                self.name,
