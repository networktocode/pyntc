...
class easy_install(Command):
    ...
    def run(self, show_deprecation=True):
        if show_deprecation:
            self.announce(
                "WARNING: The easy_install command is deprecated " "and will be removed in a future version.", log.WARN,
            )
                ...
                if "Python.framework" in prefix:
                    ...
                    if home:
                        home_sp = os.path.join(
                            home, "Library", "Python", "{}.{}".format(*sys.version_info), "site-packages",
                        )
